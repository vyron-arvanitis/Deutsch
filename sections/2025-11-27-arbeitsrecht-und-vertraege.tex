...
\deword{innerhalb von + dat}{within}{Innerhalb von drei Wochen muss man reagieren.}
...
\deword{erheben + akk}{to file, to raise}{Man kann eine Klage erheben.}
...
\deword{überfliegen + akk}{to skim}{Ich habe den Text zuerst überflogen.}
...
\deword{befolgen + akk}{to comply with, to obey}{Man muss die Anweisungen befolgen.}
...
\deword{vertrauen + dat}{to trust}{Ich vertraue meinem Team.}
...
\deword{entlassen + akk}{to dismiss, to fire, to release}{Der Mitarbeiter wurde entlassen.}
\end{vocabtable}
