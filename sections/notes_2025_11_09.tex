...
\deword{berichten}{to report, to tell; synonym: mitteilen}{Er berichtet über seine Erfahrung.}
...
\deword{absolvieren}{to complete, e.g. a course or internship; synonym: beenden}{Ich absolviere ein Praktikum.}
\deword{fassen}{to grasp, to comprehend; synonym: begreifen}{Ich kann es kaum fassen.}
\deword{bilden}{to form, create; synonym: formen}{Diese Wörter bilden einen Satz.}
...
\deword{gelten}{to apply, to be valid; synonym: zutreffen}{Diese Regel gilt für alle.}
\deword{drücken}{to press; also to express}{Er drückt den Knopf.}
